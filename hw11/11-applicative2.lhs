...
>   pure = const
>   -- to satisfy the law: (pure f) <*> g = f <$>
>   -- e must be passed to f only because SOME argument
>   -- is required. it could be ANYTHING because (pure f) x = f
>   -- since pure = const
>   f <*> x = \e -> (f e) (x e)

(e -> (a -> b)) <*> (e -> a) = \e -> ((e -> (a -> b)) e) ((e -> a) e)
(e -> (a -> b)) <*> (e -> a) = \e -> (a -> b) a
(e -> (a -> b)) <*> (e -> a) = \e -> b
...
> replicateA i = sequenceA . (replicate i)
